<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="showShop=!showShop">
      <img class="content-image"
           :src="info.avatar">
      <div class="header-content">
        <h2 class="content-title" @click="">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="showSupports=!showSupports">
    ...
    <div class="shop-brief-modal" v-show="showShop">
      <div class="brief-modal-content">
        ...
        <div  class="mask-footer" @click="showShop = !showShop">
          <span class="iconfont iconguanbibeifen" ></span>
        </div>
      </div>
